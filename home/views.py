...
def home(request):
    ...
    return render(request,"home/home.html",{"uid":uid,"list_elevage":choix_aleatoire_elevage,"list_agriculture":choix_aleatoire_agriculture,"list_users":choix_user_profils,'evaluation':100})
